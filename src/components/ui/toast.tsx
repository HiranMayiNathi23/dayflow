...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Viewport
    ref={ref}
    className={cn('fixed bottom-20 left-0 right-0 z-[100] flex max-h-screen flex-col-reverse gap-2 px-4 sm:bottom-4 sm:right-4 sm:left-auto sm:max-w-sm', className)}
    {...props}
  />
))
